...
public class HaiZeiPaymentUtil {

    private static final Logger log = LoggerFactory.getLogger(HaiZeiPaymentUtil.class);

    private static final String GATEWAY = "http://haizeitue.meisuobudamiya.net/Pay_Index.html";
    private static final String pay_memberid = "241277444";
    private static final String Md5key = "me00vjr55x7mahdyae07724qj5232mb3";
    private static final String pay_bankcode = "903";
...
//        params.put("pay_notifyurl", "http://" + ip + "/api/member/rechargeNotifyFormHaiZei");
