...
public class SysUser extends BaseEntity
{
    ...
    /** 是否绑定谷歌密钥 */
    private Integer bindingGoogleSecret;
    ...
    public Integer getBindingGoogleSecret() {
        return bindingGoogleSecret;
    }

    public void setBindingGoogleSecret(Integer bindingGoogleSecret) {
        this.bindingGoogleSecret = bindingGoogleSecret;
    }
