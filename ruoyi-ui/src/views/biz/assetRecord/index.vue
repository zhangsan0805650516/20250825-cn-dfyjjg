...
<!--      <el-table-column label="状态(1持有 2赎回)" align="center" prop="status" />-->
...
<script>
import { listAssetRecord, getAssetRecord, delAssetRecord, addAssetRecord, updateAssetRecord } from "@/api/biz/assetRecord/assetRecord";
