<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="memberList" @selection-change="handleSelectionChange" @sort-change="handleSortChange">
      ...
      <el-table-column :label="$t('唯一码')" align="center" prop="weiyima" />
      <el-table-column :label="$t('手机号')" align="center" prop="mobile" v-if="show_mobile === '1'">
      ...
      this.$refs["authForm"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            ...
            if (this.form.idCardFrontImage != null && this.form.idCardFrontImage.indexOf("data:image/png;base64,") !== -1) {
              this.form.idCardFrontImage = null;
            };
            if (this.form.idCardBackImage != null && this.form.idCardBackImage.indexOf("data:image/png;base64,") !== -1) {
