package com.ruoyi.biz.stockSgSecond.domain;
...
@TableName("fa_stock_sg_second")
@ApiModel(value = "线下配售(世纪独享)")
public class FaStockSgSecond extends BaseEntity {
    ...
    /** 中签数(手) */
    @ApiModelProperty(value = "中签数(手)")
    @Excel(name = "中签数(手)")
    @TableField("zq_num")
    private Integer zqNum;

    /** 中签数(股) 主板1签1000 其他一签500  */
    @ApiModelProperty(value = "中签数(股) 主板1签1000 其他一签500 ")
    @Excel(name = "中签数(股) 主板1签1000 其他一签500 ")
    @TableField("zq_nums")
